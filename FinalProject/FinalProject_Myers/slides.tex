...
% ============================================================
% INTRO SLIDE 1: What is Income Shifting?
% ============================================================
...
\begin{tikzpicture}[
  ...
  % Parent box
  \node[entity, fill=oucrimson!12, draw=oucrimson!70!black] (parent) at (-4, 0) {\textbf{Parent}\\\small(U.S.)};

  % Subsidiary box
  \node[entity, fill=green!10, draw=green!50!black] (sub) at (4, 0) {\textbf{Subsidiary}\\\small(Foreign)};

  % Profit shifting arrow (large, curved, on top)
  \draw[arrow, oucrimson, line width=2pt] 
  ...
  \node[font=\small, color=oucrimson!80!black] at (-1.5, 1.8) {\$};
  \node[font=\small, color=oucrimson!80!black] at (0, 2.1) {\$\$};
  \node[font=\small, color=oucrimson!80!black] at (1.5, 1.8) {\$};
  ...
  % Goods/services arrow (bottom, going right)
  \draw[arrow, blue!60!black, dashed] 
...
% ============================================================
% INTRO SLIDE 2: Income Shifting - Example 1
% ============================================================
...
\begin{tikzpicture}[
  ...
  % Customer icon at bottom right
  \node[font=\Large] at (4.5, -1.8) {\textbf{\textsf{Customer}}};
\end{tikzpicture}
...
% ============================================================
% INTRO SLIDE 3: Income Shifting - Example 2
% ============================================================
\begin{frame}{Introduction -- continued}
...
% ============================================================
% SLIDE 6d: Data - continued (Variable Definitions)
% ============================================================
\begin{frame}{Data -- continued}
\centerline{\large\textbf{Variable Definitions}}
\vspace{0.2cm}
{\small
\begin{table}
\centering
...
\begin{itemize}
    ...
    \item Post-TCJA coefficient is positive but insignificant --- \textbf{no clear evidence the reform reduced shifting}
\end{itemize}

\vspace{0.3cm}
\begin{block}{Policy Implication}
Statutory rate cuts alone may not curb profit shifting. Enforcement and base-broadening measures may also be needed.
\end{block}
