# Problem Set 10
# Using cross-validation to tune classification models using four of the 
# Five Tribes of Machine Learning: trees, neural networks, naive Bayes, 
# and k-nearest neighbor / support vector machines.
...
# NOTE: adult.data downloaded from https://archive.ics.uci.edu/dataset/2/adult
# Place in working directory before running the code below.
income <- read_csv("adult.data", col_names = FALSE)
...
############################################################################################################
# Code above is the starter code for PS10. The rest of the code is my solution to 
# the problem set, which involves tuning and testing four different classification 
# algorithms (decision tree, neural network, k-nearest neighbor, and support vector machine) 
# using tidymodels. The code is structured in a way that is very similar to the 
# logistic regression example above, with some differences in the model specifications 
...
# what is the best value of the tuning parameters?
