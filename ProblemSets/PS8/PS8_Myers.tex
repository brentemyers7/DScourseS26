...
\begin{center}
\textbf{\uline{Problem Set 8}}\\[0.5em]
\textit{Matrix Manipulation, Optimization, and Simulated Data}
\end{center}
...
Using R's built-in \texttt{lm()} function confirms all previous results. The regression table is shown below. All estimates of $\hat{\beta}$ are within a few thousandths of the ground truth $\beta$ used to generate the data, which is what we would expect given the large sample size ($N = 100{,}000$) and relatively small error variance ($\sigma^2 = 0.25$).
