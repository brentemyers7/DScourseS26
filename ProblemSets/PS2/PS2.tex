...
\begin{enumerate}
    ...
    \item Type
        ...
        where you replace \texttt{[your-github-username]} (including the brackets) with your actual GitHub username.
...
\begin{enumerate}
    ...
    \item Type \texttt{git clone git@github.com:[your-github-username]/DScourseS26.git} where you replace \texttt{[your-github-username]} (including the brackets) with your actual GitHub username.
